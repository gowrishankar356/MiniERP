...
- Created microservices to manage CRUD operations for Employee.
...
- Created different microservices for each workforce structure company, grade, department, job, location, and payroll elements.
...
- Created an UI to claculate monthly payroll which interacts with /payroll RESTful API to calculate the payroll for the respective
  month.
- Engineered a view and function to calculate the monthly payroll company wise using PostgreSQL with 100% accuracy.
...
- Navigate to Home Page > Payroll Activities > Run Payroll.
- Select respective company, month, and year to perform payroll.
  <img src="https://github.com/gowrishankar356/MiniERP/blob/main/readme_pics/payroll.png?raw=true" alt="image-description" height="300" width="600"/>
- On Click submit, it performs above procedure to calculate payroll and results are displayed as below.
  <img src="https://github.com/gowrishankar356/MiniERP/blob/main/readme_pics/payrollResults.png?raw=true" alt="image-description" height="300" width="600"/>
